<template>
  <div data-spy="scroll" data-offset="80">
    <Loader />
    <HeaderStyle1 :logo-img="logo" :nav-item-list="navItems" :styled-logo="true" class-name="header-white">
        <a href="#" class="button-line pull-right" slot="navContent">Downloadd</a>
    </HeaderStyle1>
    <nuxt />
    <ColorCustomizer />
    <ScrollTop />
